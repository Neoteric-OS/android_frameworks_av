...
PlaylistFetcher::PlaylistFetcher(
    ...
    : mNotify(notify),
      ...
      mStartup(true),
      mIDRFound(false),
// QTI_BEGIN: 2018-05-13: Audio: HLS: force audio/video both to start from IDR position
      mLastIDRFound(false),
      mLastIDRTimeUs(-1),
// QTI_END: 2018-05-13: Audio: HLS: force audio/video both to start from IDR position
